...
//         try {
//           const response = await apiRequest(`/api/admin/support-tickets/${selectedChat._id}/messages`, {
//             useAdminToken: true,
//             method: "POST",
...
//               chat.id === selectedChat._id ? response.data : chat
//             ));
//             setAdminReply("");
...
//         try {
//           const response = await apiRequest(`/api/admin/support-tickets/${selectedChat._id}`, {
//             useAdminToken: true,
//             method: "PATCH",
